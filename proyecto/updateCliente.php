                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="apellidosCliente" class="form-control <?php echo (!empty($apellidosCliente_err)) ? 'is-invalid' : ''; ?>"><?php echo $apellidosCliente; ?></textarea>
                            <span class="invalid-feedback"><?php echo $apellidosCliente_err; ?></span>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <textarea name="correoCliente" class="form-control <?php echo (!empty($correoCliente_err)) ? 'is-invalid' : ''; ?>"><?php echo $correoCliente; ?></textarea>
                        ...
                        <div class="form-group">
                            <label>Motivo</label>
                            <textarea name="motivoCliente" class="form-control <?php echo (!empty($motivoCliente_err)) ? 'is-invalid' : ''; ?>"><?php echo $motivoCliente; ?></textarea>
